...
We are giving a file to download which looks like this.
...
| ______________________________________________________________|
  ...
  This one took me a bit. You have to notice there are 15 letters in the flag and 15 rows and 21 columns. So each row gets a number
  ex: 6 for row 1 12 for row 2 ect ect..
